...
//                }
    ...
    public static void Hiencaythumuc(String path, int level){
        File file = new File(path);
        ...
        if(file.isFile()) { // Kiểm tra file là tập tin
            ...
            for(File f: files){
                Hiencaythumuc(f.getAbsolutePath(), level+1);
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        // String path = "E:\\temp\\dir1\\dir2\\dir3";
        // Xulyfile.taoThuMuc(path);

        // String path = "E:\\temp\\BAITAP.DOCX";
        // Xulyfile.taoTapTin(path);

        // String path = "E:\\temp\\baitap";
        // Xulyfile.taoThuMuc(path);

        // String path = "E:\\temp\\baitap\\BAITAP.DOCX";
        // Xulyfile.taoTapTin(path);

        // String path = "E:\\temp - Copy\\BAITAP.DOCX";
        // Xulyfile.xoa(path);

        //String path = "E:\\temp - Copy";
        //Xulyfile.xoa(path);

        // String path = "E:\\temp - Copy\\dir1\\dir2\\dir3";
        // Xulyfile.xoa(path);
        ...
        Xulyfile.KiemTraThongTin("E:\\temp");
    }
}